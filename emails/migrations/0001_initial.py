    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inboxes', to='emails.mailaccount')),
            ],
        ),
        migrations.CreateModel(
            name='Attachment',
            fields=[
                ...
                ('mail_inbox', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='emails.mailinbox')),
            ],
        ),
    ]
